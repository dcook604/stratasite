    ...
    <Dialog open={isOpen} onOpenChange={handleDialogClose}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Register your pet with Spectrum 4 Strata. Maximum 2 pets allowed per unit as per strata bylaws.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert className="border-amber-200 bg-amber-50">
          ...
          <AlertDescription className="text-amber-800">
            <div className="space-y-1">
              ...
              <p>Please fill out one form per pet. All pet registrations must be approved by strata management before pets can reside in the building.</p>
            </div>
          </AlertDescription>
        </Alert>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="TENANT" id="dialog-tenant" />
                          <label htmlFor="dialog-tenant" className="cursor-pointer">Tenant</label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="OWNER_OCCUPIED" id="dialog-owner" />
                          <label htmlFor="dialog-owner" className="cursor-pointer">Owner Occupied</label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold border-b pb-2">Pet Registration Details</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-center w-full">
                  <label htmlFor="dialog-photo-upload" className="flex flex-col items-center justify-center w-full h-24 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
...
export default PetRegistrationDialog; 