...
INSERT INTO "new_storage_locker_applications" ("address", "admin_notes", "application_id", "consent_given", "created_at", "email", "email_sent", "first_name", "id", "is_active", "last_name", "locker_id", "status", "telephone", "unit_number", "updated_at") SELECT "address", "admin_notes", "application_id", "consent_given", "created_at", "email", "email_sent", "first_name", "id", "is_active", "last_name", "locker_id", "status", "telephone", "unit_number", "updated_at" FROM "storage_locker_applications";
